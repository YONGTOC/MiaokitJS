...
define("index", ["require", "exports", "react", "react-dom", "router", "allBottom", "react-router-dom", "css!./style/index.css", "css!./style/view.css"], function (require, exports, React, ReactDOM, router_1, allBottom_1, react_router_dom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
                ...
                React.createElement("div", { className: "warp" },
                    ...
                    React.createElement("div", { className: "index-park-title" },
                        ...
                        React.createElement("div", { className: "index-park-b" },
                            ...
                            " \u5BB6\u56ED\u533A\u4E0A\u7EBF"),
                        React.createElement(react_router_dom_1.Link, { to: "/parkList" },
...
define("InfoTitle", ["require", "exports", "react", "react-router-dom"], function (require, exports, React, react_router_dom_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
                ...
                React.createElement("div", { className: "ParkInfoOne_title" },
                    ...
                    React.createElement("ul", null,
                        ...
                        [{ name: "品牌园区", url: "/parkList" }, { name: "出租房源", url: "/roomList" }, { name: "房源园区", url: "" }].map((item, index) => {
                            return (React.createElement(react_router_dom_2.Link, { to: item.url, key: index },
            ...
            return (React.createElement("div", { className: "index" },
                ...
                React.createElement("div", { className: "warp", style: { marginTop: "26px", marginBottom: "65px", overflow: "hidden" } },
                        ...
                        React.createElement("div", { style: { float: "left", width: "816px", overflow: "hidden" } },
                            ...
                            React.createElement("div", { style: { fontSize: "12px", color: "#333333", paddingTop: "30px", overflow: "hidden" } },
                                ...
                                React.createElement("div", { style: { float: "left", overflow: "hidden", marginLeft: "20px" } },
                                    React.createElement("div", { style: { float: "left", color: "#17A1E6", cursor: "pointer" } },
                                        "\u533A\u57DF",
                                        React.createElement("img", { src: "./fangliangbao/image/blue_down.png", width: "10px", height: "10px", style: { margin: "0 24px 2px 5px" } })),
                                    React.createElement("div", { style: { float: "left", cursor: "pointer" } },
                                        "\u5730\u94C1",
                                        React.createElement("img", { src: "./fangliangbao/image/black_down.png", width: "10px", height: "10px", style: { margin: "0 0 2px 5px" } }))),
                                ...
                                React.createElement("div", { style: { margin: "10px 0 0 56px" } }, this.state.districtChildArray.map((item, index) => {
                                    return (React.createElement("div", { key: index, style: { float: "left", height: "16px", marginRight: "24px", cursor: "pointer" } }, item.name));
                                })),
                                React.createElement("div", { style: { clear: "both" } }),
                                React.createElement("div", { style: { marginTop: "27px", overflow: "hidden" } },
                                    React.createElement("div", { style: { float: "left", color: "#989FA8" } }, "\u4EF7\u683C\uFF1A"),
                                    React.createElement("div", { className: "park-list-price", style: { color: "#989FA8", marginLeft: "20px", border: "1px solid #CCCCCC" } }, "\u5355\u4EF7"),
                                    React.createElement("div", { className: "park-list-price", style: { color: "#17A1E6", border: "1px solid #17A1E6", marginLeft: "-1px" } }, "\u603B\u4EF7"),
                                    React.createElement("div", { className: "park-list-price-q" },
                                        React.createElement("div", { style: { width: "11px", height: "16px", margin: "auto", marginTop: "3px", paddingTop: "7.5px" } },
                                            React.createElement("div", { style: { height: "1px", width: "5px", backgroundColor: "#CCCCCC", float: "left" } }),
                                            React.createElement("div", { style: { height: "1px", width: "5px", backgroundColor: "#CCCCCC", float: "left", marginLeft: "1px" } }))),
                                    React.createElement("div", { style: { float: "left", marginLeft: "8px", height: "22px", lineHeight: "22px" } }, "\u4E07\u5143/\u6708")),
                                React.createElement("div", { style: { margin: "10px 0 0 56px", clear: "both", overflow: "hidden" } }, this.state.priceArray.map((item, index) => {
                                    return (React.createElement("div", { key: index, style: { float: "left", marginRight: "24px" } }, item.name));
                                })))),
                        React.createElement("div", { className: "searchCont" },
                            React.createElement("input", { className: "index-iphone", value: this.state.iphoneValue }),
                            React.createElement("img", { src: "./fangliangbao/image/iphone.png", width: "18px", height: "18px", style: { position: "relative", bottom: "31px", left: "10px" } }),
                    ...
                    React.createElement("div", { style: { color: "#989FA8", marginTop: "20px", fontSize: "12px", lineHeight: "28px", overflow: "hidden" } },
                        ...
                        React.createElement("div", { className: "park-list-x" },
                            React.createElement("span", null, "\u767D\u4E91"),
                            " ",
                            React.createElement("img", { src: "./fangliangbao/image/close.png", width: "15px", height: "15px", style: { marginBottom: "2px" } })),
                        React.createElement("div", { className: "park-list-x" },
                            React.createElement("span", null, "0.5-1.5\u4E07\u5143/\u6708"),
                            " ",
                            React.createElement("img", { src: "./fangliangbao/image/close.png", width: "15px", height: "15px", style: { marginBottom: "2px" } })),
                        React.createElement("div", { style: { float: "left", marginLeft: "20px", height: "28px", lineHeight: "28px", cursor: "pointer" } },
                        ...
                        React.createElement("div", { style: { float: "left", width: "816px", overflow: "hidden" } },
                            ...
                            React.createElement("div", { style: { fontSize: "12px", color: "#333333", paddingTop: "30px", overflow: "hidden" } },
                                ...
                                React.createElement("div", { style: { marginTop: "27px", overflow: "hidden", clear: "both" } },
                                    ...
                                    React.createElement("div", { className: "park-list-price-q", style: { marginLeft: 0 } },
                                        React.createElement("div", { style: { width: "11px", height: "16px", margin: "auto", marginTop: "3px", paddingTop: "7.5px" } },
                                            React.createElement("div", { style: { height: "1px", width: "5px", backgroundColor: "#CCCCCC", float: "left" } }),
                                            React.createElement("div", { style: { height: "1px", width: "5px", backgroundColor: "#CCCCCC", float: "left", marginLeft: "1px" } }))),
                                ...
                                React.createElement("div", { style: { clear: "both" } }),
                                React.createElement("div", { style: { marginTop: "27px", overflow: "hidden", clear: "both" } },
                                    React.createElement("div", { style: { float: "left", color: "#989FA8" } }, "\u7C7B\u578B\uFF1A"),
                                    React.createElement("div", { style: { marginLeft: "56px" } }, [{ name: "全部" }, { name: "共享办公" }, { name: "独立办公" }].map((item, index) => {
                                        return (React.createElement("div", { key: index, style: { float: "left", height: "16px", marginRight: "24px", cursor: "pointer" } }, item.name));
                                    }))))),
                        React.createElement("div", { className: "searchCont" },
                            React.createElement("input", { className: "index-iphone", value: this.state.iphoneValue }),
                                ...
                                return (React.createElement("div", { key: index, style: { marginTop: index === 0 ? "18px" : "30px", overflow: "hidden", cursor: "pointer", width: "895px" } },
                                    ...
                                    React.createElement("div", { style: { float: "left", marginLeft: "30px", width: "500px" } },
                                        ...
                                        React.createElement("div", { style: { marginTop: "12px", fontSize: "12px", overflow: "hidden", color: "#849AAE" } },
                                            ...
                                            React.createElement("div", { style: { backgroundColor: "#F3F5F7", width: "77px", height: "24px", borderRadius: "2px", float: "left", textAlign: "center", lineHeight: "24px", marginRight: "10px" } }, "\u6237\u578B\u65B9\u6B63"),
                                            React.createElement("div", { style: { backgroundColor: "#F3F5F7", width: "77px", height: "24px", borderRadius: "2px", float: "left", textAlign: "center", lineHeight: "24px", marginRight: "10px" } }, "\u53EF\u6CE8\u518C"))),
                                    React.createElement("div", { className: "index-collect" },
                                        React.createElement("img", { src: "./fangliangbao/image/collect.png", width: "11px", height: "11px", style: { margin: "0 3px 2px 0" } }),
                                        React.createElement("span", { style: { color: "#B9B9B9", fontSize: "12px" } }, "\u6536\u85CF")),
...
define("router", ["require", "exports", "react-router-dom", "react", "index", "parkInfo", "parkList", "roomList"], function (require, exports, react_router_dom_3, React, index_1, parkInfo_1, parkList_1, roomList_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Router extends React.Component {
        ...
        render() {
            return (React.createElement(react_router_dom_3.HashRouter, null,
                React.createElement(react_router_dom_3.Switch, null,
                    React.createElement(react_router_dom_3.Route, { exact: true, path: "/", component: index_1.default }),
                    React.createElement(react_router_dom_3.Route, { exact: true, path: "/parkList", component: parkList_1.default }),
                    React.createElement(react_router_dom_3.Route, { exact: true, path: "/roomList", component: roomList_1.default }),
                    React.createElement(react_router_dom_3.Route, { exact: true, path: "/pi", component: parkInfo_1.default }))));
        }
    }
    exports.default = Router;
});
define("ParkInfo (2)", ["require", "exports", "react", "HomeTop", "allBottom"], function (require, exports, React, HomeTop_1, AllBottom_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("ParkInfo (3)", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle"], function (require, exports, React, HomeTop_2, AllBottom_2, InfoTitle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
...
define("ParkInfo (4)", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle"], function (require, exports, React, HomeTop_3, AllBottom_3, InfoTitle_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
...
define("ParkInfo (5)", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle"], function (require, exports, React, HomeTop_4, AllBottom_4, InfoTitle_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
...
define("ParkInfo (6)", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle"], function (require, exports, React, HomeTop_5, AllBottom_5, InfoTitle_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
...
define("ParkInfo (7)", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle"], function (require, exports, React, HomeTop_6, AllBottom_6, InfoTitle_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
...
define("ParkInfo6", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle"], function (require, exports, React, HomeTop_7, AllBottom_7, InfoTitle_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
...
define("infoTitle - \u526F\u672C", ["require", "exports", "react", "react-router-dom"], function (require, exports, React, react_router_dom_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class InfoTitle extends React.Component {
        constructor(props) {
        ...
        render() {
            return (React.createElement("div", { className: "ParkInfoOne" },
                React.createElement("div", { className: "ParkInfoOne_title" },
                    ...
                    "=======",
                    [{ name: "品牌园区", url: "/parkList" }, { name: "出租房源", url: "/roomList" }, { name: "房源园区", url: "" }].map((item, index) => {
                        return (React.createElement(react_router_dom_4.Link, { to: item.url, key: index },
                            React.createElement("li", { style: { "color": index === this.props.index ? "rgb(23, 161, 230)" : "", "font-weight": index === this.props.index ? "bold" : "" } }, item.name)));
                    }),
                    ">>>>>>> 114977fbed4ca402bece00edb2c2faacc3687585")));
            div >
            ;
        }
    }
...
define("ParkInfo - \u526F\u672C", ["require", "exports", "react", "HomeTop", "allBottom", "InfoTitle", "SendSuccess"], function (require, exports, React, HomeTop_8, AllBottom_8, InfoTitle_7, SendSuccess_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ParkInfo extends React.Component {
        constructor(props) {
        ...
        componentDidMount() {
            HomeTop_8.default.changHomeTop(2);
        ...
        render() {
            return (React.createElement("div", { className: "infoPage" },
                ...
                React.createElement("div", { className: "parkInfo" },
                    React.createElement("div", { className: "parkInfoBox_title" }),
                    React.createElement(InfoTitle_7.default, { index: 0 }),
                    "======= >>>>>>> 114977fbed4ca402bece00edb2c2faacc3687585",
                    React.createElement(ParkInfoOne, null)),
                React.createElement("div", { className: "parkInfoBox_list" },
                    React.createElement(ParkInfoTwo, null)),
