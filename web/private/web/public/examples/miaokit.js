...
class Framework {
    ...
    InitNengtou() {
        ...
        MiaokitJS.LoadPrefab("./examples/data/opt-webgl-nengtou.assetbundle", function (pPrefab) {
            pThis.m_pModel = pPrefab.Instantiate();
            bLoading = false;
        });
    }
}
MiaokitJS.UTIL = MiaokitJS.UTIL || {};
MiaokitJS.UTIL.Framework = Framework;
MiaokitJS.Framework = new Framework();
class EntityPicker {
