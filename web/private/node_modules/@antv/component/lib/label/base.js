...
var bbox_1 = require("./adjust/bbox");
var position_1 = require("./adjust/position");
var spiral_1 = require("./adjust/spiral");
var LAYOUTS = {
    scatter: position_1.default,
    map: spiral_1.default,
    treemap: bbox_1.default,
};
var Label = /** @class */ (function (_super) {
    tslib_1.__extends(Label, _super);
    function Label(cfg) {
        return _super.call(this, tslib_1.__assign({ name: 'label', type: 'default', 
