...
var Arc = /** @class */ (function (_super) {
    ...
    function Arc(cfg) {
        return _super.call(this, tslib_1.__assign({ type: 'arc', start: null, end: null, style: {
                stroke: '#999',
                lineWidth: 1,
            } }, cfg)) || this;
    }
    Arc.prototype.render = function (coord, group) {
        ...
        if (_.isNumberEqual(start.x, end.x) && _.isNumberEqual(start.y, end.y)) {
            ...
            var dAngle = matrix_util_1.vec2.angleTo([coordCenter.x - start.x, coordCenter.y - start.y], [coordCenter.x - end.x, coordCenter.y - end.y], 0);
