...
var base_2 = require("../label/base");
var theme_1 = require("./theme");
var Axis = /** @class */ (function (_super) {
    tslib_1.__extends(Axis, _super);
    function Axis(cfg) {
        var _this = _super.call(this, tslib_1.__assign({ type: 'base', id: null, line: {
                lineWidth: 1,
                stroke: '#C0D0E0',
            }, tickLine: {
                lineWidth: 1,
    ...
    Axis.prototype.render = function () {
        ...
        if (title) {
            // 渲染坐标轴标题
            this.set('title', Util.deepMix({}, theme_1.default.title, this.get('title')));
            this.renderTitle();
        }
    };
    ...
    Axis.prototype.addLabel = function (tick, point, index, tickCount) {
        ...
        if (labelCfg) {
            labelCfg = Util.deepMix({ text: tick.text }, theme_1.default.label, labelCfg);
            // 支持formatter配置
    ...
    Axis.prototype._renderLine = function () {
        ...
        var lineCfg = tslib_1.__assign({ path: path }, this.get('line'));
        ...
        Util.each(gridPoints, function (subPoints, index) {
            ...
            if (gridCfg) {
                ...
                var gridLineShape = gridGroup.addShape('path', {
                    attrs: Util.mix({ path: path_1 }, theme_1.default.grid, gridCfg),
                });
    ...
    Axis.prototype._renderLabels = function () {
        var group = this.get('group');
        var labelRenderer = new base_2.default({ name: 'axis-label' });
