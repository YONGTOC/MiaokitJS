...
var Slider = /** @class */ (function (_super) {
    ...
    function Slider(cfg) {
        ...
        var _a = sliderSize || [], _b = _a[0], w = _b === void 0 ? SLIDER_WIDTH : _b, _c = _a[1], h = _c === void 0 ? SLIDER_HEIGHT : _c;
    ...
    Slider.prototype.createSliderButton = function (group, isMin) {
        ...
        // 不同的 slider 滑块
        var buttonAttribute = __assign(__assign(__assign({}, buttonAttr), SliderBtnStyle), { cursor: this.getSliderCursor() });
    ...
    Slider.prototype.createSliderText = function (group, isMin) {
        ...
        var textAttr = __assign(__assign(__assign({}, this.textStyle), textAttribute), { text: '' });
