...
var Continuous = /** @class */ (function (_super) {
    ...
    function Continuous(cfg) {
        var _this = this;
        var backgroundStyle = cfg.backgroundStyle, fillStyle = cfg.fillStyle, textStyle = cfg.textStyle, titleStyle = cfg.titleStyle, otherCfg = __rest(cfg, ["backgroundStyle", "fillStyle", "textStyle", "titleStyle"]);
    ...
    */
    ...
    Continuous.prototype.renderSlider = function () {
        ...
        // 创建 slider
        var slider = new Slider(this.getSliderConfig());
        // 设置背景 group
