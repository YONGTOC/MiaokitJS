...
var Color = /** @class */ (function (_super) {
    ...
    function Color(cfg) {
        return _super.call(this, __assign({ type: 'color-legend' }, cfg)) || this;
    }
    ...
    Color.prototype.calculatePercent = function (items) {
        ...
        return _.map(items, function (item) {
            return __assign(__assign({}, item), { percentage: (Number(item.value) - min) / diff });
        });
    };
    /* 颜色是否分段 */
    ...
    Color.prototype.getUnOperationalGroup = function () {
        ...
        if (this.isHorizontal()) {
            ...
            _.each(items, function (item, i) {
                ...
                group.addShape('text', {
                    attrs: __assign(__assign({ x: item.percentage * width, y: height + TEXT_OFFSET, text: "" + _this.formatterValue(item.value) }, textStyle), { textBaseline: 'top', textAlign: 'center' }),
                });
            });
        }
        else {
            ...
            _.each(items, function (item, i) {
                ...
                group.addShape('text', {
                    attrs: __assign(__assign({ x: width + TEXT_OFFSET, y: (1 - item.percentage) * height, text: "" + _this.formatterValue(item.value) }, textStyle), { textAlign: 'start', textBaseline: 'middle' }),
                });
            });
        }
