...
export var getNoopFormatter = function () { return function (text, item, idx) { return text; }; };
export var getPrecisionFormatter = function (precision) { return function (text, item, idx) {
    var num = Number(text);
    return isNaN(num) || isNil(precision) ? text : num.toFixed(precision);
}; };
export var getSuffixFormatter = function (suffix) { return function (text, item, idx) {
