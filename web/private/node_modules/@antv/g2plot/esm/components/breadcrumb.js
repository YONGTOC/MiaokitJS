...
var Breadcrumb = /** @class */ (function (_super) {
    ...
    Breadcrumb.prototype.init = function (config) {
        ...
        this.separatorStyle = __assign({ textBaseline: 'top', fill: '#000', opacity: 0.45 }, (config.separatorStyle || {}));
        this.itemWidth = config.itemWidth;
        this.itemHeight = config.itemHeight;
        this.maxItemWidth = config.maxItemWidth;
        this.textStyle = __assign({ textBaseline: 'top', fill: '#000', opacity: 0.45 }, (config.textStyle || {}));
    };
