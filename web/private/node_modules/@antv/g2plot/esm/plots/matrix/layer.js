...
var MatrixLayer = /** @class */ (function (_super) {
    ...
    MatrixLayer.prototype.afterRender = function () {
        if (this.options.legend && this.options.legend.visible) {
            this.matrixLegend = new MatrixLegend(__assign({ view: this.view, plot: this }, this.options.legend));
    ...
    MatrixLayer.prototype.extractLabel = function () {
        ...
        var label = getComponent('label', __assign({ plot: this, top: true, labelType: 'matrixLabel', fields: this.options.colorField ? [this.options.colorField] : [this.options.sizeField] }, labelOptions));
        return label;
    };
