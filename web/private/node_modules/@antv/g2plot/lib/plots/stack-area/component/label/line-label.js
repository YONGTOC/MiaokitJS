...
var AreaLineElementLabels = /** @class */ (function (_super) {
    tslib_1.__extends(AreaLineElementLabels, _super);
    ...
    AreaLineElementLabels.prototype.showLabels = function (points, shapes) {
        ...
        util_1.each(shapes, function (shape) {
            ...
            var lastPoint = util_1.deepMix({}, originData[originData.length - 1]);
...
g2_1.registerElementLabels('areaLine', AreaLineElementLabels);
