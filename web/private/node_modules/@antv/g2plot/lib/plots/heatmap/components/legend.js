...
var HeatmapLegend = /** @class */ (function () {
    ...
    HeatmapLegend.prototype.renderVertical = function (min, max, colors) {
        ...
        var textMin = this.container.addShape('text', {
            attrs: tslib_1.__assign({ text: min, x: gridWidth / 2, y: this.height + LABEL_MARGIN, textAlign: 'center', textBaseline: 'top' }, this.options.text.style),
        });
        // 绘制包围线
