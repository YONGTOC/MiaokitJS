 ...
 * 计算文本在画布中的宽度
 */
exports.measureTextWidth = _.memoize(function (text, font) {
    if (font === void 0) { font = {}; }
    var fontSize = font.fontSize, fontFamily = font.fontFamily, fontWeight = font.fontWeight, fontStyle = font.fontStyle, fontVariant = font.fontVariant;
    ctx.font = [fontStyle, fontVariant, fontWeight, fontSize + "px", fontFamily].join(' ');
    return ctx.measureText(_.isString(text) ? text : '').width;
}, function (text, font) { return (font ? tslib_1.__spreadArrays([text], _.values(font)).join('') : text); });
/**
 * 获取文本的 ... 文本。
 ...
 * TODO 后续更新省略算法
 */
exports.getEllipsisText = function (text, maxWidth, font, priority) {
