...
exports.STACK_FIELD = '$$type$$';
var BaseBulletLayer = /** @class */ (function (_super) {
    tslib_1.__extends(BaseBulletLayer, _super);
    ...
    BaseBulletLayer.prototype.drawBullet = function (container, box, value) {
        ...
        if (options.label.visible) {
            ...
            var label = container.addShape('text', {
                attrs: tslib_1.__assign({ x: rect.getBBox().maxX + 4, y: rect.getBBox().minY + rect.getBBox().height / 2, text: "" + value }, labelStyle),
            });
            label.name = 'label';
        }
    };
    ...
    BaseBulletLayer.prototype.drawBulletTicks = function (container, box) {
        ...
        ticks.forEach(function (tick, tickIdx) {
            ...
            var tickText = container.addShape('text', {
                attrs: tslib_1.__assign({ x: x, y: box.minY - tickBottom, text: "" + tick }, ticksStyle),
            });
            tickText.name = 'tick';
    ...
    BaseBulletLayer.prototype.addGeometry = function () {
        var options = this.options;
        var bullet = factory_1.getGeom('interval', 'main', {
...
exports.default = BaseBulletLayer;
