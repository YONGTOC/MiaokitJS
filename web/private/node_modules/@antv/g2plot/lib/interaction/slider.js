...
var getValidSliderConfig = function (cfg) {
    if (cfg === void 0) { cfg = {}; }
    var _cfg = tslib_1.__assign({ type: 'horizontal', start: 0, end: 1, width: undefined, height: undefined, padding: [0, 0, 0, 0], backgroundColor: undefined, foregroundColor: undefined }, cfg);
    // default padding
    if (!cfg.padding) {
        _cfg.padding =
...
var SliderInteraction = /** @class */ (function (_super) {
    ...
    SliderInteraction.prototype.renderSlider = function () {
        if (!this.slider) {
            ...
            this.slider = new gui_1.Slider(this.getSliderConfig());
    ...
    SliderInteraction.prototype.getSliderConfig = function () {
        ...
        var config = getValidSliderConfig(this.getInteractionConfig());
        var _a = config || {}, _b = _a.padding, padding = _b === void 0 ? [0, 0, 0, 0] : _b, foregroundColor = _a.foregroundColor, backgroundColor = _a.backgroundColor;
        var paddingTop = padding[0], paddingRight = padding[1], paddingBottom = padding[2], paddingLeft = padding[3];
        var _c = this.getSliderMinMaxText(this.curStart, this.curEnd), minText = _c.minText, maxText = _c.maxText;
        var cfg = {
    ...
    SliderInteraction.prototype.getSliderMinMaxText = function (start, end) {
        ...
        return {
            minText: util_1.head(newData)[xField],
            maxText: util_1.last(newData)[xField],
        };
    };
