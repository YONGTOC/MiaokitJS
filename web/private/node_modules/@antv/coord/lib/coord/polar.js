...
var Polar = /** @class */ (function (_super) {
    ...
    Polar.prototype.invertPoint = function (point) {
        ...
        matrix_util_1.mat3.rotate(m, m, this.startAngle);
        var vStart = [1, 0, 0];
        matrix_util_1.vec3.transformMat3(vStart, vStart, m);
        vStart = [vStart[0], vStart[1]];
        var angle = matrix_util_1.vec2.angleTo(vStart, vPoint, this.endAngle < this.startAngle);
