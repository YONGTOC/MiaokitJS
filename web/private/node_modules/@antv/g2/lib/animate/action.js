...
function scaleInY(shape, animateCfg) {
    ...
    var endState = {
        matrix: util_1.getScaledMatrix(shape, [x, y, 1], 'y'),
    };
    util_1.doAnimation(shape, endState, animateCfg);
}
function scaleInX(shape, animateCfg) {
    ...
    var endState = {
        matrix: util_1.getScaledMatrix(shape, [x, y, 1], 'x'),
    };
    util_1.doAnimation(shape, endState, animateCfg);
}
...
function zoomIn(shape, animateCfg, coord) {
    ...
    var endState = {
        matrix: util_1.getScaledMatrix(shape, [x, y, 1], 'xy'),
    };
    util_1.doAnimation(shape, endState, animateCfg);
}
...
function clipIn(shape, animateCfg, coord, startAngle, endAngle) {
    ...
    util_1.doAnimation(clip, endState, animateCfg);
}
...
function groupScaleInX(container, animateCfg, coord, zeroY) {
    util_1.doGroupScaleIn(container, animateCfg, coord, zeroY, 'x');
}
function groupScaleInY(container, animateCfg, coord, zeroY) {
    util_1.doGroupScaleIn(container, animateCfg, coord, zeroY, 'y');
}
function groupScaleInXY(container, animateCfg, coord, zeroY) {
    util_1.doGroupScaleIn(container, animateCfg, coord, zeroY, 'xy');
}
