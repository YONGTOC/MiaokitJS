...
var scale_1 = require("./controller/scale");
var coordinate_1 = require("./controller/coordinate");
var annotation_1 = require("./controller/annotation");
var legend_1 = require("./controller/legend");
var axis_1 = require("./controller/axis");
var tooltip_1 = require("./controller/tooltip");
var shape_state_1 = require("./controller/shape-state");
...
var View = /** @class */ (function (_super) {
    ...
    function View(cfg) {
        var _this = _super.call(this, tslib_1.__assign({ animate: global_1.default.animate, widthRatio: global_1.default.widthRatio, canvas: null, container: null, coord: null, elements: [], guideController: null, id: _.uniqueId('view_'), options: {}, padding: global_1.default.theme.padding, parent: null, scaleController: null, scales: {}, start: { x: 0, y: 0 }, end: { x: 1, y: 1 }, width: null, height: null, theme: null, title: null, views: [], visible: true, backgroundStyle: {}, interactions: {} }, cfg)) || this;
        _this.init();
        return _this;
    }
    ...
    View.prototype.createView = function (cfg) {
        ...
        var newCfg = tslib_1.__assign({ theme: this.get('theme'), parent: this, container: this.get('panelGroup'), canvas: this.get('canvas'), animate: this.get('animate') }, cfg);
        // options 中的配置
    ...
    View.prototype.getElements = function (recursive) {
        ...
        var elements = tslib_1.__spreadArrays(this.get('elements'));
        if (recursive) {
            var views = this.get('views');
            _.each(views, function (view) {
    ...
    View.prototype.interaction = function (type, cfg) {
        if (cfg === void 0) { cfg = {}; }
        cfg.view = this;
        var Ctor = interaction_1.getInteraction(type);
    ...
    View.prototype._initTheme = function () {
        ...
        if (_.isObject(theme)) {
            ...
            newTheme = theme_1.getTheme(theme);
        }
        _.deepMix(viewTheme, global_1.default.theme, newTheme);
    ...
    View.prototype.initRegion = function () {
        ...
        this.set('viewRange', new g_1.BBox(startX, startY, viewWidth, viewHeight)); // 获取子 view 整体范围（包含坐标轴）
        var padding = util_1.parsePadding(this.get('padding'));
        var top = padding[0], right = padding[1], bottom = padding[2], left = padding[3];
        var panelRange = new g_1.BBox(startX + left, startY + top, viewWidth - left - right, viewHeight - top - bottom);
    ...
    View.prototype._initControllers = function () {
        ...
        var theme = this.get('theme');
        var canvas = this.get('canvas');
        var scaleController = new scale_1.default(options.scales); // TODO 支持透传图表尺寸等
        this.set('scaleController', scaleController);
        var coordController = new coordinate_1.default(options.coord);
        this.set('coordController', coordController);
        var eventController = new event_1.default({
            canvas: this.get('canvas'),
            view: this,
        });
        this.set('eventController', eventController);
        var shapeStateController = new shape_state_1.default({
            view: this,
        });
        this.set('shapeStateController', shapeStateController);
        var legendController = new legend_1.default({ view: this });
        this.set('legendController', legendController);
        var annotationController = new annotation_1.default({
        ...
        var axisController = new axis_1.default({
            canvas: canvas,
            theme: theme,
        });
        this.set('axisController', axisController);
        var tooltipController = new tooltip_1.default({
            view: this,
            theme: theme,
        });
    ...
    View.prototype._createElement = function (cfg) {
        var type = cfg.type;
        var element;
        if (element_1.getElement(type)) {
            var elementCfg = tslib_1.__assign(tslib_1.__assign({}, cfg), { container: this.get('panelGroup').addGroup(), frontgroundGroup: this.get('frontgroundGroup').addGroup(), view: this, canvas: this.get('canvas'), theme: this.get('theme') });
            var ElementCtor = element_1.getElement(type);
    ...
    View.prototype._canvasDraw = function (stopDrawing) {
        ...
        if (!stopDrawing) {
            ...
            if (this.get('animate')) {
                ...
                _.each(views, function (view) {
                    animate_1.default.execAnimation(view, isUpdate_1);
                });
                animate_1.default.execAnimation(this, isUpdate_1);
                canvas.draw();
            }
            else {
                canvas.draw();
...
exports.registerViewPrototype = function (key, Ctor) {
