...
var Heatmap = /** @class */ (function (_super) {
    ...
    function Heatmap(cfg) {
        return _super.call(this, tslib_1.__assign({ type: 'heatmap', shapeType: 'point', paletteCache: {} }, cfg)) || this;
    }
        ...
        for (var i = 3; i < pixels.length; i += 4) {
            ...
            if (alpha) {
                ...
                if (paletteCache[alpha]) {
                    ...
                    palette = dependents_1.colorUtil.rgb2arr(colorAttr.gradient(alpha / 256));
