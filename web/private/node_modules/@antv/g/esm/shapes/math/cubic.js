...
export function derivativeAt(p0, p1, p2, p3, t) {
    var onet = 1 - t;
    return 3 * (((p1 - p0) * onet + 2 * (p2 - p1) * t) * onet + (p3 - p2) * t * t);
}
export function pointDistance(x1, y1, x2, y2, x3, y3, x4, y4, x, y, out) {
    var t;
    var interval = 0.005;
    var d = Infinity;
    var _t;
...
export function len(x1, y1, x2, y2, x3, y3, x4, y4, z) {
    if (Util.isNil(z)) {
        z = 1;
    }
    z = z > 1 ? 1 : z < 0 ? 0 : z;
...
export var projectPoint = function (x1, y1, x2, y2, x3, y3, x4, y4, x, y) {
