...
var PathSegment = /** @class */ (function () {
    ...
    PathSegment.prototype.getBBox = function (lineWidth) {
        ...
        switch (this.command) {
            ...
            case 'TL':
            case 'L':
                this.box = BBox.fromRange(Math.min(params[0].x, params[1].x) - halfWidth, Math.min(params[0].y, params[1].y) - halfWidth, Math.max(params[0].x, params[1].x) + halfWidth, Math.max(params[0].y, params[1].y) + halfWidth);
                break;
            case 'SQ':
            case 'Q':
                ...
                this.box = BBox.fromRange(Math.min.apply(Math, xDims) - halfWidth, Math.min.apply(Math, yDims) - halfWidth, Math.max.apply(Math, xDims) + halfWidth, Math.max.apply(Math, yDims) + halfWidth);
                break;
            case 'C':
