...
var Base = /** @class */ (function (_super) {
    ...
    function Base(cfg) {
        ...
        _this.removed = false;
        _this.cfg = tslib_1.__assign(tslib_1.__assign({ canvas: null, capture: true, context: null, parent: null, visible: true, zIndex: 0 }, cfg), _this.getDefaultCfg());
        return _this;
    }
    /**
    ...
    Base.prototype.emit = function (evt, e) {
        ...
        // 调用 ee 的事件 emit
        _super.prototype.emit.apply(this, tslib_1.__spreadArrays([evt, e], args));
        // 阻止冒泡
        if (e instanceof event_1.default && e.propagationStopped) {
            return;
        }
        if (PROPOGATE_EVENTS.indexOf(evt) >= 0) {
            var parent_1 = this.cfg.parent;
            if (parent_1 && !parent_1.removed && !parent_1.destroyed) {
                parent_1.emit.apply(parent_1, tslib_1.__spreadArrays([evt, e], args));
            }
        }
    };
