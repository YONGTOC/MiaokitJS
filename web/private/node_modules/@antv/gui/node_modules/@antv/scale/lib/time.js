...
var bisector_1 = require("./util/bisector");
...
var Time = /** @class */ (function (_super) {
    ...
    Time.prototype._setTicks = function () {
        ...
        var idx = bisector_1.default(function (o) { return o[1]; })(intervals, target);
        ...
        var ticks = pretty_1.default(0, Math.ceil((maxDate - minDate) / d), tickCount).ticks;
        // time的tick不能取超出定义域的值
